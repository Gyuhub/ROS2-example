...
#ifndef SRV_AND_CLI_ROS2__SRV__DETAIL__TUTORIAL__FUNCTIONS_H_
#define SRV_AND_CLI_ROS2__SRV__DETAIL__TUTORIAL__FUNCTIONS_H_
 ...
 * calls
 * srv_and_cli_ros2__srv__Tutorial_Request__init().
...
/**
 * It calls
 * srv_and_cli_ros2__srv__Tutorial_Request__fini()
 ...
 * srv_and_cli_ros2__srv__Tutorial_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * srv_and_cli_ros2__srv__Tutorial_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * srv_and_cli_ros2__srv__Tutorial_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_srv_and_cli_ros2
...
/**
 * It calls
 * srv_and_cli_ros2__srv__Tutorial_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_srv_and_cli_ros2
...
/**
 * It allocates the memory for the array and calls
 * srv_and_cli_ros2__srv__Tutorial_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_srv_and_cli_ros2
...
/**
 * It calls
 * srv_and_cli_ros2__srv__Tutorial_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SRV_AND_CLI_ROS2__SRV__DETAIL__TUTORIAL__FUNCTIONS_H_
