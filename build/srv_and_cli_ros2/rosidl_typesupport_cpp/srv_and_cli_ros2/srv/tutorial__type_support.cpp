...
static const _Tutorial_Request_type_support_symbol_names_t _Tutorial_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_and_cli_ros2, srv, Tutorial_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, srv_and_cli_ros2, srv, Tutorial_Request)),
  }
};
...
{
  return &::srv_and_cli_ros2::srv::rosidl_typesupport_cpp::Tutorial_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, srv_and_cli_ros2, srv, Tutorial_Request)() {
  return get_message_type_support_handle<srv_and_cli_ros2::srv::Tutorial_Request>();
}
...
static const _Tutorial_Response_type_support_symbol_names_t _Tutorial_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_and_cli_ros2, srv, Tutorial_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, srv_and_cli_ros2, srv, Tutorial_Response)),
  }
};
...
{
  return &::srv_and_cli_ros2::srv::rosidl_typesupport_cpp::Tutorial_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, srv_and_cli_ros2, srv, Tutorial_Response)() {
  return get_message_type_support_handle<srv_and_cli_ros2::srv::Tutorial_Response>();
}
...
static const _Tutorial_type_support_symbol_names_t _Tutorial_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_and_cli_ros2, srv, Tutorial)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, srv_and_cli_ros2, srv, Tutorial)),
  }
};
...
{
  return &::srv_and_cli_ros2::srv::rosidl_typesupport_cpp::Tutorial_service_type_support_handle;
}
